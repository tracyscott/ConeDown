          ...
          if ("mobile".equals(path[2])) {
            if (path.length > 3) {
              if ("accelx".equals(path[3])) {
                ConeDown.oscSensor.accelXKnob.setValue(message.getFloat(0));
              } else if ("accely".equals(path[3])) {
                ConeDown.oscSensor.accelYKnob.setValue(message.getFloat(0));
              } else if ("accelz".equals(path[3])) {
                ConeDown.oscSensor.accelZKnob.setValue(message.getFloat(0));
              }
            }
          }
        }
