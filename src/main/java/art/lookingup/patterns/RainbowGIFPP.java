...
public class RainbowGIFPP extends RainbowGIFBase {
  ...
  protected void renderToPoints() {
    ...
    RenderImageUtil.sampleRenderTarget(ConeDown.getProjection(ConeDown.DEFAULT_SUPER_SAMPLING), renderTarget.getValuei(), images[(int)currentFrame], colors, xOffset ,yOffset);
  }
}
