...
public class Spiral2Full extends Pattern {

  public Spiral2Full(LX lx) {
    this(lx, ConeDown.pApplet, ConeDownModel.POINTS_WIDE, ConeDownModel.POINTS_HIGH);
  }

  public Spiral2Full(LX lx, PApplet app, int width, int height) {
    super(lx, app, width, height);
    this.setFragment(
        new Blend.Factory("", new Spiral.Factory("t"), new Spiral.InvertedFactory("b")));
  }
};
