...
public class Flags extends RPattern {
  ...
  public void render(double deltaMs) {
    ...
    flag = flags[flagNum];
    int numPixelsPerRow = ConeDownModel.POINTS_WIDE;
    int pointNumber = 0;
    for (LXPoint p : model.points) {
      int[] imageCoords = ConeDownModel.pointToImageCoordinates(p);
      int rowNumber = (ConeDownModel.POINTS_HIGH-1)-imageCoords[1];
